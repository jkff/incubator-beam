...
public class PAssert {
  ...
  private static class PCollectionSingletonIterableAssert<T> implements IterableAssert<T> {
    ...
    public PCollectionSingletonIterableAssert(
        ...
        AssertionWindows rewindowingStrategy,
        SimpleFunction<Iterable<ValueInSingleWindow<Iterable<T>>>, Iterable<Iterable<T>>> paneExtractor) {
      this.actual = actual;
    ...
    public PCollection<Iterable<ValueInSingleWindow<T>>> apply(PCollection<T> input) {
      ...
      PCollection<KV<Integer, Iterable<ValueInSingleWindow<T>>>> groupedContents =
          ...
          input
              ...
              .apply("KeyForDummy", WithKeys.<Integer, Iterable<ValueInSingleWindow<T>>>of(combinedKey))
